...
## SSL
SSl - защищает пароли при передачи, без SSL  хакеры могут украсть данные пользователей. На сайте с паролями SSL обязательный! Без него ссылка будет без http:// и иметь запись 🔓 Не защищено.